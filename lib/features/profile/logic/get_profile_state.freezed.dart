...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetProfileState<T>);
}
...
/// @nodoc
class $GetProfileStateCopyWith<T,$Res>  {
$GetProfileStateCopyWith(GetProfileState<T> _, $Res Function(GetProfileState<T>) __);
}


/// Adds pattern-matching-related methods to [GetProfileState].
extension GetProfileStatePatterns<T> on GetProfileState<T> {
...
class _Initial<T> implements GetProfileState<T> {
  const _Initial();
...
class Loading<T> implements GetProfileState<T> {
  const Loading();
...
class Success<T> implements GetProfileState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $GetProfileStateCopyWith<T, $Res> {
...
class Error<T> implements GetProfileState<T> {
...
@override
String toString() {
  return 'GetProfileState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $GetProfileStateCopyWith<T, $Res> {
